          ...
          try {
            const data = await AsyncStorage.getItem("@sessiondata");
              if (data !== null) {
                ...
                fetch("http://ffapi.moncea.ro/public//api/users/"+ JSON.parse(data)['id'] +"/subscriptions", requestOptions)
                .then(response => response.text())
                .then(result => {
                    setMemberships(JSON.parse(result)['data']);
                                ...
                                <View key={n['id']}>
                                    {n["active"] == "1" ? (
                                        ...
                                        <View style={{flexDirection: "row", justifyContent: "space-between"}}>
                                            <View>
                                                <Text style={{fontSize: 16, color: "#5CBBBB", fontWeight: "bold"}}>{n["name"]}</Text>
                                                <Text style={{color: "#696969"}}>3 Dec 2021 - 3 Jan 2021</Text>
                                            </View>
                                            <Text style={{fontSize: 16, color: "#A0A0A0"}}>Unlimited</Text>
                                        </View>
                                        <Text style={{color: "#979797", marginTop: 10}}>{n["remaining_sessions"]} sessions left</Text>
                                    ...
                                    <View style={styles.membershipCardInvalid}>
                                        <View style={{flexDirection: "row", justifyContent: "space-between"}}>
                                            <View>
                                                <Text style={{fontSize: 16, color: "#A3A3A3", fontWeight: "bold"}}>{n["name"]}</Text>
                                                <Text style={{color: "#696969"}}>3 Dec 2021 - 3 Jan 2021</Text>
                                            </View>
